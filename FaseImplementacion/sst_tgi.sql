...
-- ==============================================================================
DROP DATABASE IF EXISTS sst_tgi;
...
BEGIN 
    ...
    SELECT idAsistencia, asistio INTO v_id_asistencia, v_asistio
    FROM asistencia
